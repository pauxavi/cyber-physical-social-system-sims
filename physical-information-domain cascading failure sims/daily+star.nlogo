...
to setup
  random-seed 121 ;;Fixed random seed
  clear-all
...
to setup-nodes
  ...
  [
    ...
    set maintenance-check-timer maintenance-check-frequency ;;The maintenance cycle of each node（ Limited by total maintenance resources)
